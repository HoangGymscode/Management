...
public class DealerList extends ArrayList<Dealer> {
    ...
    public void searchDealer() {
        System.out.print("Enters ID: ");
        Scanner sc = new Scanner(System.in);
        String  ID = sc.nextLine().toLowerCase();
//        String ProductNameList = Utils.getString("Enters ProductName: ");
        search(this, ID);
    }
    ...
    public void search(ArrayList<Dealer> dealers, String ID) {
        ...
        for ( Dealer dealer : this) {
            if (dealer.getID().toLowerCase().contains(ID)) {
                newList.add(dealer);
            }
        }
        ...
        if (newList.isEmpty()) {
            ...
            newList.sort(new Comparator<Dealer>() {
                ...
                @Override
                public int compare(Dealer p1, Dealer p2) {
